...
contract DeployMarketResolver is Script {
    ...
    address constant UMA_OPTIMISTIC_ORACLE_V2 = 0xA5B9d8a0B0Fa04Ba71BDD68069661ED5C0848884;
    ...
    MarketFactory public simpleFactory;
    ...
    function run() public {
        ...
        console.log("ParimutuelMarketFactory deployed at:", address(parimutuelFactory));
        
        simpleFactory = new MarketFactory(
            USDC_BASE,
            address(marketResolver), // Use resolver as default resolver
            address(marketResolver)
        );
        
        console.log("MarketFactory deployed at:", address(simpleFactory));
    ...
    function verifyDeployment() internal view {
        ...
        require(address(marketResolver.optimisticOracle()) == UMA_OPTIMISTIC_ORACLE_V2, "Invalid oracle address");
        require(address(marketResolver.bondCurrency()) == USDC_BASE, "Invalid bond currency");
        require(marketResolver.owner() == marketResolverOwner, "Invalid resolver owner");
        
        // Verify ParimutuelMarketFactory
        require(address(parimutuelFactory.usdc()) == USDC_BASE, "Invalid USDC in ParimutuelFactory");
        require(address(parimutuelFactory.marketResolver()) == address(marketResolver), "Invalid resolver in ParimutuelFactory");
        
        // Verify MarketFactory
        require(address(simpleFactory.usdc()) == USDC_BASE, "Invalid USDC in MarketFactory");
        require(address(simpleFactory.marketResolver()) == address(marketResolver), "Invalid resolver in MarketFactory");
    ...
    function logDeploymentSummary() internal view {
        ...
        console.log("MarketFactory:", address(simpleFactory));
        console.log("");
        ...
        console.log("Liveness Period:", marketResolver.LIVENESS_PERIOD(), "seconds");
        console.log("");
        console.log("=== NEXT STEPS ===");
        console.log("1. Platform markets will be resolved via UMA Optimistic Oracle V2");
        console.log("2. User markets will be resolved by their creators");
        console.log("3. To resolve a platform market:");
        console.log("   - Call requestPlatformResolution() after market expires");
        ...
        console.log("   - Market creator calls resolveUserMarket() after expiry");
        console.log("");
        console.log("=== USAGE EXAMPLE ===");
        console.log("// Create platform market (resolved by UMA)");
        console.log("factory.createMarket('Will BTC hit $100k?', endTime, true);");
        console.log("");
        console.log("// Create user market (resolved by creator)");
        console.log("factory.createMarket('My personal prediction', endTime, false);");
    }
    ...
    function runTestnet() public {
        ...
        address mockOracle = vm.envOr("MOCK_ORACLE_ADDRESS", UMA_OPTIMISTIC_ORACLE_V2);
