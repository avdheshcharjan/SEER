                ...
                try {
                    ...
                    for (const prediction of pendingBatch) {
                        try {
                            ...
                            const marketExists = await ParimutuelSupabaseService.getMarket(prediction.marketId);
                            if (!marketExists) {
                            ...
                            const existingPrediction = await ParimutuelSupabaseService.getUserPredictions(user.id);
                            ...
                            if (!isDuplicate) {
                                await ParimutuelSupabaseService.createPrediction({
