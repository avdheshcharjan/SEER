...
import { Clock, DollarSign, ExternalLink, Plus, Settings, Share, Target, TrendingDown, TrendingUp, Trophy } from 'lucide-react';
...
export function Profile({ onCreateMarket }: ProfileProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen font-geist text-white relative w-full items-center">
      <div className='max-w-md pt-4 px-4'>
        ...
        {/* Profile Header */}
        <div className="liquid-glass rounded-3xl p-6 mb-6 bg-gradient-to-br from-slate-900/60 to-black/40 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.4)]">
          <div className="mb-4">
            <Identity
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="liquid-glass-subtle rounded-2xl p-4 bg-slate-800/20">
        ...
        {/* Test USDC Faucet */}
        <div className="liquid-glass-light rounded-2xl p-4 mb-6 bg-slate-800/20">
          <div className="text-center">
            ...
            <motion.button
              onClick={onCreateMarket || (() => router.push('/create'))}
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto">
              {createdMarkets
                ...
                .map((market) => (
                  <motion.div
                    key={market.id}
                    className="liquid-glass-subtle rounded-2xl p-3 bg-gradient-to-r from-slate-900/20 to-indigo-950/20"
        ...
        {createdMarkets.length === 0 && onCreateMarket && (
          <div className="mb-6">
            <div className="liquid-glass-subtle rounded-2xl p-4 bg-gradient-to-br from-slate-900/20 to-indigo-950/20 text-center">
              ...
              <motion.button
                onClick={onCreateMarket}
                className="bg-gradient-to-r from-slate-700 to-indigo-700 hover:from-slate-600 hover:to-indigo-600 text-white font-medium py-2 px-4 rounded-lg transition-all duration-300"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
        ...
        <div className="mb-6">
          ...
          {allPredictions.length === 0 ? (
            <div className="liquid-glass-light rounded-xl p-6 bg-slate-800/20 text-center">
